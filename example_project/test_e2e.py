# """End-to-end tests for the django-tomselect package."""
...
#     """Return the first object in the data list."""
#     return data[0]


# @pytest.fixture(autouse=True)
# def noperms_user():
#     """Return a user without any permissions."""
...
#     """Log in a user and add the session cookie for the logged-in user to the current context."""
...
#     """Return the TomSelect css wrapper."""
...
#     """Tests for the multiple select view."""
...
#     """Tests for the tabular select view."""
...
#     """Tests for the tabular select view with a value field."""
...
#     """Tests for the 'add' button in the dropdown footer."""
...
#     """Tests for the 'listview' button in the dropdown footer."""
...
#     """Return the magazine select element."""
