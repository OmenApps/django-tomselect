(() => {
  ...
  var require_tom_select_complete = __commonJS({
    "node_modules/tom-select/dist/js/tom-select.complete.js"(exports, module) {
      (function(global, factory) {
        ...
        const isHtmlString2 = (arg) => {
          if (typeof arg === "string" && arg.indexOf("<") > -1) {
            return true;
          }
          return false;
        };
        const escapeQuery2 = (query) => {
        ...
        const getTail2 = (list, direction = 0) => {
          if (direction > 0) {
        ...
        const replaceNode2 = (existing, replacement) => {
        ...
        const highlight2 = (element, regex) => {
          ...
          const highlightText = (node) => {
            ...
            if (match && node.data.length > 0) {
              ...
              replaceNode2(middlebit, spannode);
              return 1;
            }
            return 0;
          };
        ...
        const KEY_A2 = 65;
        const KEY_RETURN2 = 13;
        const KEY_ESC2 = 27;
        const KEY_LEFT2 = 37;
        const KEY_UP2 = 38;
        const KEY_RIGHT2 = 39;
        const KEY_DOWN2 = 40;
        const KEY_BACKSPACE2 = 8;
        const KEY_DELETE2 = 46;
        const KEY_TAB2 = 9;
        const IS_MAC2 = typeof navigator === "undefined" ? false : /Mac/.test(navigator.userAgent);
        const KEY_SHORTCUT2 = IS_MAC2 ? "metaKey" : "ctrlKey";
        var defaults = {
          options: [],
          optgroups: [],
          plugins: [],
        ...
        const debounce_events2 = (self2, types, fn) => {
          var type;
        ...
        function getSettings2(input, settings_user) {
          ...
          var init_select = () => {
            ...
            var addGroup = (optgroup) => {
              ...
              iterate3(optgroup.children, (option) => {
                addOption(option, id);
              });
            };
            settings_element.maxItems = input.hasAttribute("multiple") ? null : 1;
            iterate3(input.children, (child) => {
          ...
          var init_textbox = () => {
            ...
            if (!data_raw) {
              ...
              iterate3(settings_element.options, (opt) => {
        ...
        var instance_i2 = 0;
        class TomSelect3 extends MicroPlugin2(MicroEvent2) {
          // @deprecated 1.8
          constructor(input_arg, user_settings) {
            ...
            const settings = getSettings2(input, user_settings);
            this.settings = settings;
            this.input = input;
            this.tabIndex = input.tabIndex || 0;
            this.is_select_tag = input.tagName.toLowerCase() === "select";
            this.rtl = /rtl/i.test(dir);
            this.inputId = getId2(input, "tomselect-" + instance_i2);
            this.isRequired = input.required;
            this.sifter = new Sifter2(this.options, {
            ...
            this.setupCallbacks();
            this.setupTemplates();
            const wrapper = getDom2("<div>");
            const control = getDom2("<div>");
            const dropdown = this._render("dropdown");
            const dropdown_content = getDom2(`<div role="listbox" tabindex="-1">`);
            const classes = this.input.getAttribute("class") || "";
            const inputMode = settings.mode;
            var control_input;
            addClasses2(wrapper, settings.wrapperClass, classes, inputMode);
          ...
          setup() {
            ...
            const control_id = getId2(focus_node, self2.inputId + "-ts-control");
            const query = "label[for='" + escapeQuery2(self2.inputId) + "']";
            const label = document.querySelector(query);
            const label_click = self2.focus.bind(self2);
            if (label) {
              addEvent2(label, "click", label_click);
              setAttr2(label, {
                for: control_id
              });
              const label_id = getId2(label, self2.inputId + "-ts-label");
              setAttr2(focus_node, {
            ...
            if (!settings.splitOn && settings.delimiter) {
              settings.splitOn = new RegExp("\\s*" + escape_regex2(settings.delimiter) + "+\\s*");
            }
            if (settings.load && settings.loadThrottle) {
              settings.load = loadDebounce2(settings.load, settings.loadThrottle);
            }
            ...
            addEvent2(dropdown, "mouseenter", (e) => {
              var target_match = parentMatch2(e.target, "[data-selectable]", dropdown);
              if (target_match)
                self2.onOptionHover(e, target_match);
            }, {
              capture: true
            });
            addEvent2(dropdown, "click", (evt) => {
              const option = parentMatch2(evt.target, "[data-selectable]");
              if (option) {
                self2.onOptionSelect(evt, option);
                preventDefault2(evt, true);
              }
            });
            addEvent2(control, "click", (evt) => {
              var target_match = parentMatch2(evt.target, "[data-ts-item]", control);
            ...
            addEvent2(focus_node, "keydown", (e) => self2.onKeyDown(e));
            addEvent2(control_input, "keypress", (e) => self2.onKeyPress(e));
            addEvent2(control_input, "input", (e) => self2.onInput(e));
            addEvent2(focus_node, "blur", (e) => self2.onBlur(e));
            addEvent2(focus_node, "focus", (e) => self2.onFocus(e));
            addEvent2(control_input, "paste", (e) => self2.onPaste(e));
            ...
            addEvent2(document, "mousedown", doc_mousedown);
            addEvent2(window, "scroll", win_scroll, passive_event);
            addEvent2(window, "resize", win_scroll, passive_event);
            this._destroy = () => {
          ...
          sync(get_settings = true) {
            const self2 = this;
            const settings = get_settings ? getSettings2(self2.input, {
          ...
          onKeyDown(e) {
            ...
            if (self2.isInputHidden && !isKeyDown2(KEY_SHORTCUT2, e)) {
              preventDefault2(e);
            }
          }
          /**
          ...
          setActiveItem(item, e) {
            ...
            if (eventName === "click" && isKeyDown2("shiftKey", e) && self2.activeItems.length) {
              ...
              preventDefault2(e);
            } else if (eventName === "click" && isKeyDown2(KEY_SHORTCUT2, e) || eventName === "keydown" && isKeyDown2("shiftKey", e)) {
          ...
          refreshOptions(triggerDropdown = true) {
            ...
            if (self2.settings.highlight) {
              removeHighlight2(dropdown_content);
          ...
          addOption(data, user_created = false) {
            ...
            const key = hash_key2(data[self2.settings.valueField]);
          ...
          updateOption(value, data) {
            ...
            if (option) {
              if (self2.dropdown_content.contains(option)) {
                ...
                replaceNode2(option, option_new);
          ...
          getItem(item) {
            ...
            var value = hash_key2(item);
            return value !== null ? this.control.querySelector(`[data-value="${addSlashes2(value)}"]`) : null;
          }
          /**
          ...
          updateOriginalInput(opts = {}) {
            ...
            if (self2.is_select_tag) {
              let AddSelected = function(option_el, value, label2) {
                if (!option_el) {
                  option_el = getDom2('<option value="' + escape_html2(value) + '">' + escape_html2(label2) + "</option>");
                }
              ...
              if (self2.items.length == 0 && self2.settings.mode == "single") {
                ...
                self2.items.forEach((value) => {
                  ...
                  if (selected.includes(option.$option)) {
                    const reuse_opt = self2.input.querySelector(`option[value="${addSlashes2(value)}"]:not(:checked)`);
          ...
          open() {
            ...
            if (self2.isLocked || self2.isOpen || self2.settings.mode === "multi" && self2.isFull())
              return;
            self2.isOpen = true;
            setAttr2(self2.focus_node, {
              "aria-expanded": "true"
            });
            self2.refreshState();
            applyCSS2(self2.dropdown, {
              visibility: "hidden",
              display: "block"
            });
            self2.positionDropdown();
          ...
          deleteSelection(e) {
            ...
            var self2 = this;
            direction = e && e.keyCode === KEY_BACKSPACE2 ? -1 : 1;
            selection = getSelection2(self2.control_input);
            const rm_items = [];
            if (self2.activeItems.length) {
              tail = getTail2(self2.activeItems, direction);
              caret = nodeIndex2(tail);
              if (direction > 0) {
                caret++;
              }
          ...
          advanceSelection(direction, e) {
            ...
            if (self2.inputValue().length)
              return;
            if (isKeyDown2(KEY_SHORTCUT2, e) || isKeyDown2("shiftKey", e)) {
          ...
          getLastActive(direction) {
            ...
            if (result) {
              return getTail2(result, direction);
            }
          }
          /**
          ...
          render(templateName, data) {
            ...
            if (templateName === "option" || templateName === "item") {
              const value = get_hash2(data[self2.settings.valueField]);
              setAttr2(html, {
                "data-value": value
              });
        ...
        function clear_button(userOptions) {
          ...
          self2.on("initialize", () => {
            var button = getDom2(options.html(options));
        ...
        function dropdown_header(userOptions) {
          ...
          self2.on("initialize", () => {
            var header = getDom2(options.html(options));
        ...
        function dropdown_input() {
          ...
          self2.hook("before", "setup", () => {
            ...
            const div = getDom2('<div class="dropdown-input-wrap">');
            div.append(self2.control_input);
            self2.dropdown.insertBefore(div, self2.dropdown.firstChild);
            const placeholder = getDom2('<input class="items-placeholder" tabindex="-1" />');
          ...
          self2.on("initialize", () => {
            ...
            addEvent2(self2.control_input, "blur", () => self2.onBlur());
        ...
        function input_autogrow() {
          ...
          self2.on("initialize", () => {
            ...
            addEvent2(control, "input", resize);
            addEvent2(control, "keyup", resize);
            addEvent2(control, "blur", resize);
            addEvent2(control, "update", resize);
          });
        }
        ...
        function optgroup_columns() {
          ...
          self2.hook("instead", "onKeyDown", (evt) => {
            ...
            index = nodeIndex2(self2.activeOption, "[data-selectable]");
            if (!optgroup) {
              return;
            }
        ...
        function remove_button(userOptions) {
          ...
          self2.hook("after", "setupTemplates", () => {
            ...
            self2.settings.render.item = (data, escape) => {
              var item = getDom2(orig_render_item.call(self2, data, escape));
              var close_button = getDom2(html);
              item.appendChild(close_button);
              addEvent2(close_button, "mousedown", (evt) => {
                preventDefault2(evt, true);
              });
              addEvent2(close_button, "click", (evt) => {
                preventDefault2(evt, true);
                if (self2.isLocked)
                  return;
  ...
  // node_modules/tom-select/src/tom-select.ts
  var instance_i = 0;
  var TomSelect2 = class extends MicroPlugin(MicroEvent) {
    constructor(input_arg, user_settings) {
      super();
      this.order = 0;
      this.isOpen = false;
  ...
  TomSelect2.define("checkbox_options", plugin_default);
  TomSelect2.define("clear_button", plugin_default2);
  TomSelect2.define("dropdown_header", plugin_default3);
  TomSelect2.define("dropdown_input", plugin_default4);
  TomSelect2.define("remove_button", plugin_default5);
  TomSelect2.define("virtual_scroll", plugin_default6);
