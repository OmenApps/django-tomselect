(() => {
  ...
  var require_microevent = __commonJS({
    "node_modules/tom-select/dist/cjs/contrib/microevent.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      function forEvents2(events, callback) {
        events.split(/\s+/).forEach((event) => {
          callback(event);
        });
      }
      var MicroEvent2 = class {
        constructor() {
          this._events = {};
        }
        on(events, fct) {
          forEvents2(events, (event) => {
      ...
      exports.default = MicroEvent2;
    }
  });

  // node_modules/tom-select/dist/cjs/contrib/microplugin.js
  var require_microplugin = __commonJS({
    "node_modules/tom-select/dist/cjs/contrib/microplugin.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.default = MicroPlugin2;
      function MicroPlugin2(Interface) {
        Interface.plugins = {};
        return class extends Interface {
          ...
          initializePlugins(plugins) {
            ...
            if (Array.isArray(plugins)) {
              plugins.forEach((plugin7) => {
                if (typeof plugin7 === "string") {
                  queue.push(plugin7);
                } else {
                  self.plugins.settings[plugin7.name] = plugin7.options;
                  queue.push(plugin7.name);
                }
              });
            } else if (plugins) {
              for (key in plugins) {
          ...
          loadPlugin(name) {
            ...
            var plugin7 = Interface.plugins[name];
            if (!Interface.plugins.hasOwnProperty(name)) {
              throw new Error('Unable to find "' + name + '" plugin');
            }
            plugins.requested[name] = true;
            plugins.loaded[name] = plugin7.fn.apply(self, [self.plugins.settings[name] || {}]);
  ...
  // node_modules/@orchidjs/unicode-variants/dist/cjs/regex.js
  var require_regex = __commonJS({
    "node_modules/@orchidjs/unicode-variants/dist/cjs/regex.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      exports.arrayToPattern = arrayToPattern2;
      var sequencePattern2 = (array) => {
      ...
      exports.sequencePattern = sequencePattern2;
      var setToPattern2 = (chars) => {
        let array = Array.from(chars);
        return (0, exports.arrayToPattern)(array);
      };
      exports.setToPattern = setToPattern2;
      var hasDuplicates2 = (array) => {
        return new Set(array).size !== array.length;
      };
      exports.hasDuplicates = hasDuplicates2;
      var escape_regex2 = (str) => {
        return (str + "").replace(/([\$\(\)\*\+\.\?\[\]\^\{\|\}\\])/gu, "\\$1");
      };
      exports.escape_regex = escape_regex2;
      var maxValueLength2 = (array) => {
        return array.reduce((longest, value) => Math.max(longest, (0, exports.unicodeLength)(value)), 0);
      };
      exports.maxValueLength = maxValueLength2;
      var unicodeLength2 = (str) => {
        return Array.from(str).length;
      };
      exports.unicodeLength = unicodeLength2;
    }
  });

  // node_modules/@orchidjs/unicode-variants/dist/cjs/strings.js
  var require_strings = __commonJS({
    "node_modules/@orchidjs/unicode-variants/dist/cjs/strings.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.allSubstrings = void 0;
      var allSubstrings2 = (input) => {
        if (input.length === 1)
          return [[input]];
        let result = [];
      ...
      exports.allSubstrings = allSubstrings2;
    }
  });

  // node_modules/@orchidjs/unicode-variants/dist/cjs/index.js
  var require_cjs = __commonJS({
    "node_modules/@orchidjs/unicode-variants/dist/cjs/index.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      exports.generator = generator2;
      var regex_ts_1 = require_regex();
      Object.defineProperty(exports, "escape_regex", { enumerable: true, get: function() {
        return regex_ts_1.escape_regex;
      } });
      var strings_ts_1 = require_strings();
      exports.code_points = [[0, 65535]];
      var accent_pat2 = "[\u0300-\u036F\xB7\u02BE\u02BC]";
      var multi_char_reg2;
      var max_char_length2 = 3;
      var latin_convert2 = {};
      var latin_condensed2 = {
        "/": "\u2044\u2215",
        "0": "\u07C0",
        "a": "\u2C65\u0250\u0251",
        "aa": "\uA733",
      ...
      for (let latin in latin_condensed2) {
        let unicode = latin_condensed2[latin] || "";
        for (let i = 0; i < unicode.length; i++) {
          let char = unicode.substring(i, i + 1);
          latin_convert2[char] = latin;
        }
      }
      var convert_pat2 = new RegExp(Object.keys(latin_convert2).join("|") + "|" + accent_pat2, "gu");
      var initialize2 = (_code_points) => {
        if (exports.unicode_map !== void 0)
          return;
        exports.unicode_map = (0, exports.generateMap)(_code_points || exports.code_points);
      };
      exports.initialize = initialize2;
      var normalize2 = (str, form = "NFKD") => str.normalize(form);
      ...
      exports.asciifold = asciifold2;
      var _asciifold2 = (str) => {
        str = (0, exports.normalize)(str).toLowerCase().replace(convert_pat2, (char) => {
          return latin_convert2[char] || "";
        });
        return (0, exports.normalize)(str, "NFC");
      };
      exports._asciifold = _asciifold2;
      function* generator2(code_points2) {
        for (const [code_point_min, code_point_max] of code_points2) {
          for (let i = code_point_min; i <= code_point_max; i++) {
            ...
            if (folded.length > max_char_length2) {
              continue;
            }
            if (folded.length == 0) {
              continue;
      ...
      var generateSets2 = (code_points2) => {
        const unicode_sets = {};
        ...
        for (let value of generator2(code_points2)) {
          addMatching(value.folded, value.folded);
          addMatching(value.folded, value.composed);
        }
        return unicode_sets;
      };
      exports.generateSets = generateSets2;
      var generateMap2 = (code_points2) => {
        const unicode_sets = (0, exports.generateSets)(code_points2);
        const unicode_map2 = {};
        let multi_char = [];
        for (let folded in unicode_sets) {
          let set = unicode_sets[folded];
          if (set) {
            unicode_map2[folded] = (0, regex_ts_1.setToPattern)(set);
          }
          if (folded.length > 1) {
        ...
        multi_char_reg2 = new RegExp("^" + multi_char_patt, "u");
        return unicode_map2;
      };
      exports.generateMap = generateMap2;
      var mapSequence2 = (strings, min_replacement = 1) => {
      ...
      exports.mapSequence = mapSequence2;
      var substringsToPattern2 = (str, min_replacement = 1) => {
      ...
      exports.substringsToPattern = substringsToPattern2;
      var sequencesToPattern2 = (sequences, all = true) => {
      ...
      var inSequences2 = (needle_seq, sequences) => {
      ...
      var getPattern2 = (str) => {
        ...
        for (let i = 0; i < str.length; i++) {
          ...
          let match = substr.match(multi_char_reg2);
          ...
          if (overlapping.length > 0) {
            ...
            for (let clone of overlapping) {
              if (inSequences2(clone, sequences)) {
                continue;
              }
          ...
          if (i > 0 && added_types.size == 1 && !added_types.has("3")) {
            pattern += sequencesToPattern2(sequences, false);
        ...
        pattern += sequencesToPattern2(sequences, true);
        return pattern;
      };
      exports.getPattern = getPattern2;
    }
  });

  // node_modules/@orchidjs/sifter/dist/cjs/utils.js
  var require_utils = __commonJS({
    "node_modules/@orchidjs/sifter/dist/cjs/utils.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.cmp = exports.iterate = exports.propToArray = exports.scoreValue = exports.getAttrNesting = exports.getAttr = void 0;
      var unicode_variants_1 = require_cjs();
      var getAttr2 = (obj, name) => {
        if (!obj)
          return;
        return obj[name];
      };
      exports.getAttr = getAttr2;
      var getAttrNesting2 = (obj, name) => {
        if (!obj)
          return;
      ...
      exports.getAttrNesting = getAttrNesting2;
      var scoreValue2 = (value, token, weight) => {
        var score, pos;
        if (!value)
          return 0;
        value = value + "";
      ...
      exports.scoreValue = scoreValue2;
      var propToArray2 = (obj, key) => {
        var value = obj[key];
      ...
      exports.propToArray = propToArray2;
  ...
  // node_modules/@orchidjs/sifter/dist/cjs/types.js
  var require_types = __commonJS({
    "node_modules/@orchidjs/sifter/dist/cjs/types.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
    }
  });
  ...
  var require_sifter = __commonJS({
    "node_modules/@orchidjs/sifter/dist/cjs/sifter.js"(exports) {
      "use strict";
      ...
      Object.defineProperty(exports, "scoreValue", { enumerable: true, get: function() {
        return utils_ts_1.scoreValue;
      } });
      Object.defineProperty(exports, "getAttr", { enumerable: true, get: function() {
        return utils_ts_1.getAttr;
      } });
      Object.defineProperty(exports, "getAttrNesting", { enumerable: true, get: function() {
        return utils_ts_1.getAttrNesting;
      } });
      Object.defineProperty(exports, "propToArray", { enumerable: true, get: function() {
        return utils_ts_1.propToArray;
      } });
      Object.defineProperty(exports, "iterate", { enumerable: true, get: function() {
        return utils_ts_1.iterate;
      } });
      Object.defineProperty(exports, "cmp", { enumerable: true, get: function() {
        return utils_ts_1.cmp;
      } });
      var unicode_variants_1 = require_cjs();
      Object.defineProperty(exports, "getPattern", { enumerable: true, get: function() {
        return unicode_variants_1.getPattern;
      } });
      var Sifter2 = class {
        items;
        // []|{};
  ...
  var require_utils2 = __commonJS({
    "node_modules/tom-select/dist/cjs/utils.js"(exports) {
      ...
      exports.hash_key = hash_key3;
      var get_hash3 = (value) => {
        if (typeof value === "boolean")
          return value ? "1" : "0";
        return value + "";
      };
      exports.get_hash = get_hash3;
      var escape_html3 = (str) => {
        return (str + "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;");
      };
      exports.escape_html = escape_html3;
      var timeout2 = (fn, timeout3) => {
        if (timeout3 > 0) {
          return window.setTimeout(fn, timeout3);
        }
        fn.call(null);
        return null;
      };
      exports.timeout = timeout2;
      var loadDebounce2 = (fn, delay) => {
        var timeout3;
      ...
      exports.loadDebounce = loadDebounce2;
      var debounce_events2 = (self, types, fn) => {
        var type;
      ...
      exports.debounce_events = debounce_events2;
      var getSelection2 = (input) => {
        return {
      ...
      exports.preventDefault = preventDefault6;
      var addEvent4 = (target, type, callback, options) => {
        target.addEventListener(type, callback, options);
      };
      exports.addEvent = addEvent4;
      var isKeyDown2 = (key_name, evt) => {
        if (!evt) {
          return false;
        }
        if (!evt[key_name]) {
      ...
      exports.getId = getId2;
      var addSlashes2 = (str) => {
        return str.replace(/[\\"']/g, "\\$&");
      };
      exports.addSlashes = addSlashes2;
  ...
  // node_modules/tom-select/dist/cjs/vanilla.js
  var require_vanilla = __commonJS({
    "node_modules/tom-select/dist/cjs/vanilla.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      exports.isHtmlString = isHtmlString7;
      var escapeQuery2 = (query) => {
        return query.replace(/['"\\]/g, "\\$&");
      };
      exports.escapeQuery = escapeQuery2;
      var triggerEvent2 = (dom_el, event_name) => {
        var event = document.createEvent("HTMLEvents");
        event.initEvent(event_name, true, false);
        dom_el.dispatchEvent(event);
      };
      exports.triggerEvent = triggerEvent2;
      var applyCSS2 = (dom_el, css) => {
        Object.assign(dom_el.style, css);
      };
      exports.applyCSS = applyCSS2;
      var addClasses4 = (elmts, ...classes) => {
      ...
      exports.addClasses = addClasses4;
      ...
      exports.removeClasses = removeClasses2;
      ...
      exports.classesArray = classesArray4;
      ...
      exports.castAsArray = castAsArray4;
      ...
      exports.parentMatch = parentMatch2;
      var getTail2 = (list, direction = 0) => {
        if (direction > 0) {
          return list[list.length - 1];
        }
        return list[0];
      };
      exports.getTail = getTail2;
      ...
      var replaceNode2 = (existing, replacement) => {
        if (existing.parentNode)
          existing.parentNode.replaceChild(replacement, existing);
      };
      exports.replaceNode = replaceNode2;
    }
  });

  // node_modules/tom-select/dist/cjs/contrib/highlight.js
  var require_highlight = __commonJS({
    "node_modules/tom-select/dist/cjs/contrib/highlight.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.removeHighlight = exports.highlight = void 0;
      var vanilla_ts_1 = require_vanilla();
      var highlight2 = (element, regex) => {
        if (regex === null)
          return;
      ...
      exports.removeHighlight = removeHighlight2;
    }
  });

  // node_modules/tom-select/dist/cjs/constants.js
  var require_constants = __commonJS({
    "node_modules/tom-select/dist/cjs/constants.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      ...
      exports.KEY_SHORTCUT = exports.IS_MAC ? "metaKey" : "ctrlKey";
    }
  });

  // node_modules/tom-select/dist/cjs/defaults.js
  var require_defaults = __commonJS({
    "node_modules/tom-select/dist/cjs/defaults.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.default = {
        options: [],
  ...
  var require_getSettings = __commonJS({
    "node_modules/tom-select/dist/cjs/getSettings.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.default = getSettings2;
      var defaults_ts_1 = require_defaults();
      var utils_ts_1 = require_utils2();
      function getSettings2(input, settings_user) {
        ...
        var init_textbox = () => {
          ...
          if (!data_raw) {
            ...
            (0, utils_ts_1.iterate)(values, (value2) => {
              const option = {};
  ...
  var require_tom_select = __commonJS({
    "node_modules/tom-select/dist/cjs/tom-select.js"(exports) {
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: true });
      var microevent_ts_1 = require_microevent();
      var microplugin_ts_1 = require_microplugin();
      var sifter_1 = require_sifter();
      var unicode_variants_1 = require_cjs();
      var highlight_ts_1 = require_highlight();
      var constants = require_constants();
      var getSettings_ts_1 = require_getSettings();
      var utils_ts_1 = require_utils2();
      var vanilla_ts_1 = require_vanilla();
      var instance_i2 = 0;
      var TomSelect2 = class extends (0, microplugin_ts_1.default)(microevent_ts_1.default) {
        constructor(input_arg, user_settings) {
          ...
          this.inputId = (0, utils_ts_1.getId)(input, "tomselect-" + instance_i2);
        ...
        getItem(item) {
          ...
          return value !== null ? this.control.querySelector(`[data-value="${(0, utils_ts_1.addSlashes)(value)}"]`) : null;
        }
        /**
        ...
        updateOriginalInput(opts = {}) {
          ...
          if (self.is_select_tag) {
            let AddSelected = function(option_el, value, label2) {
              if (!option_el) {
                option_el = (0, vanilla_ts_1.getDom)('<option value="' + (0, utils_ts_1.escape_html)(value) + '">' + (0, utils_ts_1.escape_html)(label2) + "</option>");
              }
  ...
  function plugin3(userOptions) {
    ...
    self.on("initialize", () => {
      var header = getDom4(options.html(options));
  ...
  function plugin4() {
    ...
    self.hook("before", "setup", () => {
      ...
      const div = getDom5('<div class="dropdown-input-wrap">');
      div.append(self.control_input);
      self.dropdown.insertBefore(div, self.dropdown.firstChild);
      const placeholder = getDom5('<input class="items-placeholder" tabindex="-1" />');
    ...
    self.on("initialize", () => {
      ...
      addEvent2(self.control_input, "blur", () => self.onBlur());
  ...
  function plugin5(userOptions) {
    ...
    self.hook("after", "setupTemplates", () => {
      ...
      self.settings.render.item = (data, escape) => {
        var item = getDom6(orig_render_item.call(self, data, escape));
        var close_button = getDom6(html);
        item.appendChild(close_button);
        addEvent3(close_button, "mousedown", (evt) => {
          preventDefault5(evt, true);
        });
        addEvent3(close_button, "click", (evt) => {
          if (self.isLocked) return;
          preventDefault5(evt, true);
          if (self.isLocked) return;
  ...
  TomSelect.define("checkbox_options", plugin);
  TomSelect.define("clear_button", plugin2);
  TomSelect.define("dropdown_header", plugin3);
  TomSelect.define("dropdown_input", plugin4);
  TomSelect.define("remove_button", plugin5);
  TomSelect.define("virtual_scroll", plugin6);
  TomSelect.define("dropdown_footer", plugin_default);
  window.TomSelect = require_tom_select();
})();
